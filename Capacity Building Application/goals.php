...
if (file_exists("goalsSaveData/$saveFile")) {
    ...
    while(! feof($fn))  {
        ...
        elseif ($line !== "next") {
            ...
            $gGroup = $gGroup."<strong>". $rName[0]. ": </strong>" . $offset ."<br> ";
        }
        //if the line is a next line
        elseif ($line == "next") {
            ${"rec".$recNum} = $gGroup;
...
//When save is clicked
    if(isset($_POST['save'])) {
        ...
        if(isset($name)) {
            $contents="";
            $recNum = 1;
            if (file_exists("goalsSaveData/$npName.txt")) {
                $newFile = fopen("goalsSaveData/$npName.txt", "w");
...
<body>
    ...
    <br>
    <a href="index.php" id="backG">← Back to Surveys  </a>
    <br><br>
    <a href="edit.php" id="recArrow">← Back to Recommendations  </a>
    <a href="actionSteps.php" id="goalArrowG">Continue to Action Steps →</a>
    </div> <!-- end buttons div -->
    <?php 
        $show = $_SESSION['show'];
    ...
    <section id="workspace">
        <table id="all">
            <tr>
                ...
                <button <?php if($collapse) echo "id='collapsed'"; else echo "id='collapse'";  ?> name = 'collapseBtn' <?php echo "value = '$val'";?>>                        <?php if($collapse) echo ">"; else echo "<"; ?> </button>
                <td class="recs <?php if($collapse) echo "collapsed"; ?>">
                ...
                <td class="recs">
                    ...
                    <textarea name = 'r1' placeholder='Type your goals here...' class="type"> <?php if(isset($r1)) echo "$r1";?></textarea>
                </td>
            </tr>
            <tr>
                <td class="recs">
                ...
                <td class="recs">
                    ...
                    <textarea name = 'r2' placeholder="Type your goals here..." class="type"> <?php if(isset($r2)) echo "$r2";?></textarea>
                </td>
            </tr>  
            <tr>
                <td class="recs">
                ...
                <td class="recs">
                    ...
                    <textarea name = 'r3' placeholder="Type your goals here..." class="type"> <?php if(isset($r3)) echo "$r3";?></textarea>
                </td>
            </tr>
            <tr>    
                <td class="recs">
                ...
                <td class="recs">
                    ...
                    <textarea name = 'r4' placeholder="Type your goals here..." class="type"> <?php if(isset($r4)) echo "$r4";?></textarea>
                </td>
            </tr>
            <tr>  
                <td class="recs">
                ...
                <td class="recs">
                    ...
                    <textarea name = 'r5' placeholder="Type your goals here..." class="type"><?php if(isset($r5)) echo "$r5";?></textarea>
                </td>
            </tr>
            <tr>   
                <td class="recs">
                ...
                <td class="recs">
                    ...
                    <textarea name = 'r6' placeholder="Type your goals here..." class="type"> <?php if(isset($r6)) echo "$r6";?></textarea>
                </td>
            </tr>
            <tr>  
                <td class="recs">
                ...
                <td class="recs">
                    ...
                    <textarea name = 'r7' placeholder="Type your goals here..." class="type"><?php if(isset($r7)) echo "$r7";?></textarea>
                </td>
            </tr>
            <tr>  
                <td class="recs">
                ...
                <td class="recs">
                   <h3>NCCNP Suggested Goals</h3>
                    ...
                    <textarea name = 'r8' placeholder="Type your goals here..." class="type"> <?php if(isset($r8)) echo "$r8";?></textarea>
                </td>
            </tr>
            <tr>  
                <td class="recs">
                ...
                <td class="recs">
                    ...
                    <textarea name = 'r9' placeholder="Type your goals here..." class="type"><?php if(isset($r9)) echo "$r9";?></textarea>
                </td>
            </tr>
            <tr>  
                <td class="recs">
                ...
                <td class="recs">
                    ...
                    <textarea name = 'r10' placeholder="Type your goals here..." class="type"><?php if(isset($r10)) echo "$r10";?></textarea>
                </td>
            </tr>
            <tr>  
                <td class="recs">
                ...
                <td class="recs">
                    ...
                    <textarea name = 'r11' placeholder="Type your goals here..." class="type"><?php if(isset($r11)) echo "$r11";?></textarea>
                </td>
            </tr>
            <tr>
                <td class="recs">
                ...
                <td class="recs">
                    ...
                    <textarea name = 'r12' placeholder="Type your goals here..." class="type"><?php if(isset($r12)) echo "$r12";?></textarea>
                </td>
            </tr>
        </table>
        </form>
