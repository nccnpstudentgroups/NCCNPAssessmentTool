  ...
  //If a name has been entered
    ...
    if(isset($name)) {
      for ($i = 1; $i <= 12; $i++){
        $select = 'r'.$i;
        if(!empty($_POST[$select]) && $_POST[$select] !== ' ') {
          $sql = "INSERT INTO `Recommendations`(`Nonprofit`, `User`, `Number`, `Goals`) VALUES (?,?,?,?)";
...
<body>
    ...
    <div id="buttons">
    <form method='post' action='goals2.php' enctype="multipart/form-data">
    ...
    <a href="edit2.php" id="back">← Back to Recommendations  </a>
    <a href="actionSteps2.php" id="goalArrow">Continue to Action Steps →</a>
    </div> <!-- end buttons div -->
    <?php
        $show = $_SESSION['show'];
    ...
    <section id="workspace">
        <table id="all">
            <tr>
                ...
                <td class="recs <?php if($collapse) {echo " hide";} ?>">
                ...
                <td <?php if($collapse) echo "class='collapseGoals'"; else echo "class='goals'";  ?>>
                    ...
                    <textarea name = 'r1' placeholder='Type your goals here...' class="type" autofocus> <?php if(isset($r1)) echo "$r1";?></textarea>
                </td>
            </tr>
            <tr>
                <td class="survey">
